<x-app-layout>
    ...
    <div class="flex justify-center">
        <h1 class="text-center lg:text-2xl font-bold leading-normal text-gray-800 xs:text-xs">
            OFICINA ACREDITACIÓN Y CALIDAD
          </h1>
    </div>
            ...
            <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3 ">
                ...
                <article class="overflow-hidden rounded-lg shadow-2xl bg-white">
                    <a class="flex justify-center" href="{{route('posts.category', $categories[0])}}">
                        <img class="h-60 w-full object-scale-down md:w-48 mx-4 p-4" alt="Placeholder" class="block h-auto w-full" src="https://i.pinimg.com/736x/f9/33/2f/f9332fd3172a685acc11038857e3078a.jpg">
                    </a>

                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">GUÍA</div>
                        <p class="text-gray-700 text-base">
                            Una guía es algo que tutela, rige u orienta. A partir de esta definición, el término puede hacer referencia a múltiples significados de acuerdo al contexto.
                        </p>
                    </div>
            ...
            <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3 ">
                ...
                <article class="overflow-hidden rounded-lg shadow-2xl bg-white">
                    <a class="flex justify-center" href="{{route('posts.category', $categories[1])}}">
                        <img class="h-60 w-full object-scale-down md:w-48 mx-4 p-4" alt="Placeholder" class="block h-auto w-full" src="https://www-cdn-4.winshuttle.com/wp-content/uploads/2017/01/operations-circle.png">
                    </a>

                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">PROCESOS</div>
                        <p class="text-gray-700 text-base">
                            Un proceso es una secuencia de acciones que se llevan a cabo para lograr un fin determinado. Un proceso se trata entonces, en general, de una serie de operaciones realizadas en orden específico y con un objetivo.
                        </p>
                    </div>
            ...
            <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3 ">
                ...
                <article class="overflow-hidden rounded-lg shadow-2xl bg-white">
                    <a class="flex justify-center" href="{{route('posts.category', $categories[2])}}">
                        <img class="h-60 w-full object-scale-down md:w-48 mx-4 p-4" alt="Placeholder" class="block h-auto w-full" src="https://png.pngtree.com/png-clipart/20190614/original/pngtree-documents-vector-icon-png-image_3758958.jpg">
                    </a>

                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">DOCUMENTOS</div>
                        <p class="text-gray-700 text-base">
                            Se almacenan documentos de AcreditaciÓn y Calidad que son Útiles para su posterior admnistración. 
                            Los documentos que se guardan son tipo PDF y Docx.
                        </p>
                    </div>
